...
class DisparateImpactRemover(object):
    ...
    def fit_transform(self, dataset, protected_index):
        ...
        repairer = self.Repairer(features, protected_index, self.repair_level, False)
        ...
        repaired.features[:, protected_index] = dataset.features[:, protected_index]
